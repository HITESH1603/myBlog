    ...
    return (
        <div className="mx-8 sm:mx-16 xl:mx-24 relative">
            <div className="text-center mt-20 mb-8">
                <div className="inline-flex item-center justify-center gap-4 px-6 py-1.5
                ...
                <p className="my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500">Your voice matters. <br/>
                 Discover articles from real people on real topics. Write, read, and connect.</p>
